    ...
    return (
        <div className="content">
            ...
            <div className="content__box">
                <p className="content__description content__description--offer"><span>Mniejszy dom</span> to 4 pokoje. Dwa na parterze i&nbsp;dwa na
                ...
                <p className="content__description content__description--offer"><span>Większy dom</span> to 4 pokoje na piętrze, z&nbsp;balkonami.
                    ...
                    dostępne w&nbsp;części wspólnej dla 4 pokoi.
                </p>
            </div>
            <p className="content__description content__description--amenities">
                <span>Udogodnienia:</span><br/>
                Przy każdym domu miejsce z&nbsp;biesiadnym stołem.
                Możliwość grillowania.<br/>
